...
const demoRows: Row[] = Array.from({ length: 10 }).map((_, i) => ({
  ...
  declarationTotal: '—',
  vatTotal: '—',
  status: i % 3 === 0 ? 'ثبت‌شده' : 'در انتظار ارسال',
  role: 'عادی',
  branch: 'شعبه اصلی',
  branchCode: '—',
  issueDate: '—/—/—',
...
// مجموع اعلامیه، مالیات بر ارزش افزوده، وضعیت اعلامیه، تاریخ صدور، شعبه، نقش مودی،
// موضوع اعلامیه، سال، دوره، تاریخ درج در کارپوشه
...
export default function PurchaseAnnouncementsImportsPage() {
  ...
  return (
    <div className="space-y-4 mx-auto w-full max-w-[1200px] px-4">
      {/* تیتر صفحه */}
      <h1 className="text-xl md:text-2xl font-bold">اعلامیه‌های واردات</h1>
