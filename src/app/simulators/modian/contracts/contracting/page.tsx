...
const PAGE_TITLE = 'قراردادهای پیمانکاری';
...
const columnsConfig: ColumnConfig[] = [
  ...
  {
    key: 'c17',
    label: 'مسئولیت ماده ۱۸',
    defaultVisible: false,
    headerClassName: COMMON_HEADER_CLASS,
    cellClassName: COMMON_CELL_CLASS,
    renderCell: (row) => row.article18Responsibility,
  },
  {
    key: 'c18',
    label: 'وضعیت قرارداد',
...
export default function ModianContractsContractingPage() {
    ...
    <>
      ...
      <div className="space-y-4 mx-auto w-full max-w-[1200px] px-4">
        ...
        <SearchByFilters
          ...
          summaryTitle=""
          onSubmit={(vals) => {
            // TODO: اتصال به API لیست قراردادهای پیمانکاری
            console.log('filters (contracts/contracting)', vals);
          }}
        />
        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            <button
              ...
              onClick={() =>
                router.push('/simulators/modian/contracts/contracting/new')
              }
            >
              ثبت قرارداد جدید
            </button>
          ...
          <ScrollableTableShell>
            ...
            {rows.map((r, i) => (
                  <tr key={i} className="border-t">
                    ...
                    >
                      <Link
                        href={`/simulators/modian/contracts/contracting/detail?contractNo=${encodeURIComponent(
                          r.contractNo,
                        )}`}
                      >
                        جزئیات
...
// پیکربندی فیلدهای نوار جستجو برای «قراردادهای پیمانکاری»
