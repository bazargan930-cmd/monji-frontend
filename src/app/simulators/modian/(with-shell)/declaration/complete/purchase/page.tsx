// src/app/simulators/modian/declaration/complete/purchase/page.tsx
        ...
        <div className="w-full px-6 py-8 bg-gray-50 min-h-screen">
            ...
            <div className="bg-white rounded-lg border">
                ...
                <div className="border-b bg-gray-100 px-4 py-3 font-semibold text-sm">
                    ب - اطلاعات خرید خاص کالاها و خدمات
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td className="border px-3 py-2">
                                        خرید خالص کالا و خدمات مشمول موضوع ماده (7) (نقدی و نسیه)
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="border px-3 py-2 text-right">۳۸۱,۸۳۳</td>
                                    <td className="border px-3 py-2">
                                        <input
                                            type="text"
                                            className="w-full border rounded px-2 py-1 text-right"
                                ...
                                <tr>
                                    ...
                                    <td className="border px-3 py-2">
                                        کسر می‌شود: اعتبار مالیاتی مربوط به خریدهای نقدی مازاد بر سقف موضوع ماده(6) "فانون پایانه های فروشگاهی و سامانه مودیان" بابت کالاها و خدمات موضوع ماده(7)
                                    </td>
                                    <td className="border px-3 py-2 text-center">0</td>
                                    <td className="border px-3 py-2 text-right">۰</td>
                                    <td className="border px-3 py-2 text-right">۰</td>
                                ...
                                <tr className="bg-green-900 text-white font-semibold">
                                    <td colSpan={6} className="border px-3 py-2 text-right">
                                        جمع مالیات و عوارض ارزش افزوده خرید کالاها و خدمات
                                    </td>
                                    <td className="border px-3 py-2 text-right">
                                        ۲۷,۵۶۹,۳۳۳,۱۸۵
                                    </td>
