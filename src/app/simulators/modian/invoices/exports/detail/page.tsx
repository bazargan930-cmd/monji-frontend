...
export default function ModianInvoiceExportsDetailPage() {
  ...
  // در این صفحه فقط ستون‌های داده‌ای (بدون «انتخاب»، «ردیف» و «شناسه کالا/خدمت»)
  // در نوار «نمایش ستون‌ها» نمایش داده می‌شوند؛ مجموعاً ۲۲ ستون (c4 تا c25).
  const itemsColumnLabels: Record<string, string> = {
    ...
    c10: 'وزن خالص',
    c11: 'نوع ارز',
    c12: 'نرخ برابری ارز با ریال/نرخ فروش ارز (ریال)',
    c13: 'نرخ مالیات بر ارزش افزوده',
    c14: 'مبلغ مالیات بر ارزش افزوده',
    c15: 'موضوع سایر مالیات و عوارض',
    c16: 'نرخ سایر مالیات و عوارض',
    c17: 'مبلغ سایر مالیات و عوارض (ریال)',
    c18: 'موضوع سایر وجوه قانونی',
    c19: 'نرخ سایر وجوه قانونی',
    c20: 'مبلغ سایر وجوه قانونی (ریال)',
    c21: 'مبلغ کل کالا/خدمت (ریال)',
    c22: 'شماره قرارداد حق‌العملکاری',
    c23: 'وضعیت واکنش آمر',
    c24: 'تاریخ و زمان واکنش آمر',
    c25: 'روزهای باقیمانده جهت واکنش آمر',
  };

  const createDefaultItemsCols = () =>
    ({
      // سه ستون اول همیشه قابل نمایش هستند (در نوار نمایش ستون‌ها نمی‌آیند)
      c1: true, // انتخاب
      c2: true, // ردیف
      c3: true, // شناسه کالا/خدمت
      // ستون‌های پیش‌فرض (مطابق وضعیت پیش‌فرض اسکرین – مجموعاً ۷ ستون داده‌ای)
      c4: true, // شرح
      c5: true, // واحد اندازه‌گیری
      c6: true, // تعداد/مقدار
      c7: true, // مبلغ واحد (ریال)
      c8: true, // ارزش ریالی کالا
      c9: true, // ارزش ارزی کالا
      c10: true, // وزن خالص
      // بقیه ستون‌ها در حالت پیش‌فرض خاموش هستند
      c11: false, // نوع ارز
      c12: false, // نرخ برابری ارز با ریال/نرخ فروش ارز (ریال)
      c13: false, // نرخ مالیات بر ارزش افزوده
      c14: false, // مبلغ مالیات بر ارزش افزوده
      c15: false, // موضوع سایر مالیات و عوارض
      c16: false, // نرخ سایر مالیات و عوارض
      c17: false, // مبلغ سایر مالیات و عوارض (ریال)
      c18: false, // موضوع سایر وجوه قانونی
      c19: false, // نرخ سایر وجوه قانونی
      c20: false, // مبلغ سایر وجوه قانونی (ریال)
      c21: false, // مبلغ کل کالا/خدمت (ریال)
      c22: false, // شماره قرارداد حق‌العملکاری
      c23: false, // وضعیت واکنش آمر
      c24: false, // تاریخ و زمان واکنش آمر
      c25: false, // روزهای باقیمانده جهت واکنش آمر
  ...
  const showAllItemsCols = () =>
    setItemsColsVisible((prev) => ({
      // سه ستون اول بدون تغییر می‌مانند
      ...prev,
      // همه ستون‌های داده‌ای (c4 تا c25) روشن می‌شوند
          ...
          <table className="w-full border-collapse text-center text-sm whitespace-nowrap">
            <thead className="bg-[#d1f7f5] text-gray-800">
              <tr>
                ...
                {/* 12 - نرخ برابری ارز با ریال/نرخ فروش ارز (ریال) */}
                <th
                  style={{
                ...
                {/* 25 - روزهای باقیمانده جهت واکنش آمر */}
                <th
                  style={{
