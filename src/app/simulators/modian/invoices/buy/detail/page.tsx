...
export default function ModianInvoiceBuyDetailPage() {
  ...
  // هندلر خروجی اکسل جدول پرداخت (اسکلت CSV با پسوند .xlsx برای تست UI)
  const handlePaymentsExcelExport = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'modian-invoice-payments-sample.xlsx');
  ...
  const handleItemsExcelExport = () => {
    ...
    const link = document.createElement('a');
    link.href = url;
    link.setAttribute('download', 'modian-invoice-items-sample.xlsx');
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    window.URL.revokeObjectURL(url);
    ...
    <div className="space-y-10 mx-auto w-full max-w-[1200px] px-4 pt-0 pb-4 -mt-4">
      ...
      <InvoiceDetailSection
        ...
        more={
          <div className="mt-4 grid gap-4 md:grid-cols-2 items-start">
            <div className="flex items-center justify-between">
              <span className="text-sm">ماللیات موضوع ماده 17:</span>
              <span className="text-sm">---</span>
            </div>
          </div>
        }
      ...
      <section className="mt-6">
        ...
        <div className="flex items-center justify-between pt-2 pb-0 w-full">
          ...
          <div className="flex items-center gap-2 text-sm font-semibold">
            ...
            <button
              type="button"
              aria-label="خروجی اکسل جدول پرداخت"
              onClick={handlePaymentsExcelExport}
            >
              <IconExcelExport className="h-9 w-9" />
            </button>
            <button
          ...
          <table className="w-full text-sm text-center border-collapse">
            <thead className="bg-[#d1f7f5ff]">
              <tr>
                ...
                {/* 7 - سهم مالیات بر ارزش افزوده از پرداخت (ریال) */}
                <th
                  style={{
                    display: paymentsColsVisible.p7 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  سهم مالیات بر ارزش افزوده از پرداخت (ریال)
                </th>
                {/* 8 - سهم سایر مالیات، عوارض و وجوه قانونی از پرداخت (ریال) */}
                <th
                  style={{
                    display: paymentsColsVisible.p8 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  سهم سایر مالیات، عوارض و وجوه قانونی از پرداخت (ریال)
                </th>
                {/* 9 - مجموع مبلغ پرداختی */}
                <th
                  style={{
                    display: paymentsColsVisible.p9 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  مجموع مبلغ پرداختی (ریال)
                </th>
                {/* 10 - روزهای باقیمانده جهت واکنش */}
                <th
                  style={{
                    display: paymentsColsVisible.p10 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  روزهای باقیمانده جهت واکنش
                ...
                <th
                  style={{
                    display: paymentsColsVisible.p11 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  تاریخ واکنش مودی
                </th>
                {/* 12 - زمان واکنش روی پرداخت */}
                <th
                  style={{
                    display: paymentsColsVisible.p12 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  زمان واکنش روی پرداخت
                </th>
                {/* 13 - وضعیت عدول از حد مجاز ماده ۶ */}
                <th
                  style={{
                    display: paymentsColsVisible.p13 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  وضعیت عدول از حد مجاز ماده ۶
                </th>
                {/* 14 - بدهی فروشنده از این پرداخت */}
                <th
                  style={{
                    display: paymentsColsVisible.p14 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  بدهی فروشنده از این پرداخت
                </th>
                {/* 15 - اعتبار خریدار از این پرداخت */}
                <th
                  style={{
                    display: paymentsColsVisible.p15 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  اعتبار خریدار از این پرداخت
                </th>
                {/* 16 - زمان ابطال پرداخت */}
                <th
                  style={{
                    display: paymentsColsVisible.p16 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  زمان ابطال پرداخت
                </th>
                {/* 17 - زمان ثبت در کارپوشه */}
                <th
                  style={{
                    display: paymentsColsVisible.p17 ? 'table-cell' : 'none',
                  }}
                  className="border px-2 py-1 whitespace-nowrap"
                >
                  زمان ثبت در کارپوشه
            ...
            <tbody>
              <tr className="odd:bg-white even:bg-gray-50">
                ...
                <td
                  ...
                  className="border px-2 py-1 whitespace-nowrap text-orange-600"
                >
                  در انتظار واکنش
                </td>
                <td
